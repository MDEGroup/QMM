...
/**
 * QualitymetamodelLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * QualitymetamodelLayoutInformations are aggregated in LayoutInformationAdapters.
 * One QualitymetamodelLayoutInformation contains the layout that was found before
 * a keyword, attribute or reference.
 */
public class QualitymetamodelLayoutInformation {
	 ...
	 */
	private final QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelSyntaxElement syntaxElement;
	...
	public QualitymetamodelLayoutInformation(QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelSyntaxElement getSyntaxElement() {
