...
public class QualitymetamodelNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "QualityMetamodel.resource.qualitymetamodel.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
