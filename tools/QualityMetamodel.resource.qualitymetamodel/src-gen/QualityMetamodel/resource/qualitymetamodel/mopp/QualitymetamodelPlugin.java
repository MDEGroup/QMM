 ...
 */
public class QualitymetamodelPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "QualityMetamodel.resource.qualitymetamodel";
	/**
	...
	private static QualitymetamodelPlugin plugin;
	
	public QualitymetamodelPlugin() {
		super();
	}
	...
	public static QualitymetamodelPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, QualitymetamodelPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, QualitymetamodelPlugin.PLUGIN_ID, message);
		}
		final QualitymetamodelPlugin pluginInstance = QualitymetamodelPlugin.getDefault();
