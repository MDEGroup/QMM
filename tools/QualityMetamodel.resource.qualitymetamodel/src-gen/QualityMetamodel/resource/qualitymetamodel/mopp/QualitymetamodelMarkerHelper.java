 ...
 * contains
 * <code>QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextDiagnostic
 * </code>s it uses the more precise information of this extended diagnostic type.
 */
public class QualitymetamodelMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>> commands = new java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>> commandsToProcess = new java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextDiagnostic diagnostic) {
		final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelProblem problem = diagnostic.getProblem();
		QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemSeverity.ERROR) {
					...
					QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextDiagnostic textDiagnostic = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType nextType : QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(QualityMetamodel.resource.qualitymetamodel.QualitymetamodelEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
