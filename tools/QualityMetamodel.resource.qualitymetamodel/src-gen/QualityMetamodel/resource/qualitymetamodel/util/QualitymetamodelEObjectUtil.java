 ...
 */
public class QualitymetamodelEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			new QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelRuntimeUtil().logError("Exception while matching proxy URI.", e);
