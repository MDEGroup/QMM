 ...
 */
public class QualitymetamodelRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
