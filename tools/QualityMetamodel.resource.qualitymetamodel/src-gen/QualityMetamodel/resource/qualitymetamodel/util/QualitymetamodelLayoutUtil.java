 ...
 */
public class QualitymetamodelLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelSyntaxElement syntaxElement = QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelPlaceholder) {
			QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelPlaceholder placeholder = (QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelPlaceholder) syntaxElement;
			QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTokenResolver tokenResolver = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTokenResolveResult result = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
