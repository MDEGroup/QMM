 ...
 */
public class QualitymetamodelResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource getResource(java.io.File file) {
	...
	public static QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource) resource;
	}
	 ...
	 */
	public static QualityMetamodel.QualityModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static QualityMetamodel.QualityModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (QualityMetamodel.QualityModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static QualityMetamodel.QualityModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
