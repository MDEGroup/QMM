...
public class QualitymetamodelStackFrame extends QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget target;
	private String name;
	private int id;
	...
	public QualitymetamodelStackFrame(QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelStringUtil.decode(data, ',');
	...
	private QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelStackFrame other = (QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelStackFrame) obj;
		if (name == null) {
