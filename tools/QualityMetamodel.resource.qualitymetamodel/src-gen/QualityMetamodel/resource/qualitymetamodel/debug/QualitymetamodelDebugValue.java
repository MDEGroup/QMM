...
public class QualitymetamodelDebugValue extends QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public QualitymetamodelDebugValue(QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
