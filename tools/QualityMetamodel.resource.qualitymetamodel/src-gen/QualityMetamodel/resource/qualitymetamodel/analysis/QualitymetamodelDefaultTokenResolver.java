 ...
 */
public class QualitymetamodelDefaultTokenResolver implements QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTokenResolver {
	 ...
	 */
	public QualitymetamodelDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public QualitymetamodelDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelGrammarInformationProvider.INSTANCE.getKeywords()) {
