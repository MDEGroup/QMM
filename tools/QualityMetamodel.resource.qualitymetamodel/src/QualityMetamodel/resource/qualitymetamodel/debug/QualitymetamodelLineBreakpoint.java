...
public class QualitymetamodelLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "QualityMetamodel.resource.qualitymetamodel.debug.lineBreakpoint.marker";
	
	public QualitymetamodelLineBreakpoint() {
		super();
	}
	
	public QualitymetamodelLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget target) {
		try {
	...
	public void remove(QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
