 ...
 * @since 3.2
 */
public class QualitymetamodelBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput fInput;
	 ...
	 */
	public QualitymetamodelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public QualitymetamodelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public QualitymetamodelBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput);
		...
		fInput= (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput) input;
		...
		QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput getInput() {
		return fInput;
	}
