 ...
 */
public class QualitymetamodelBracketSet {
	...
	private java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair {
	 ...
	 */
	private class ClosingListener implements QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public QualitymetamodelBracketSet(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair>();
	 ...
	 */
	public QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair getBracketPair(String opening, String closing) {
		for (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair : bracketPairs) {
	...
	public QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair remove(String opening, String closing) {
		for (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
