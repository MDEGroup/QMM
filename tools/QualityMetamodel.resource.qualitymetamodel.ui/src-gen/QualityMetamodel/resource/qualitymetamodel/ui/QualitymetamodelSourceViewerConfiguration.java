 ...
 */
public class QualitymetamodelSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public QualitymetamodelSourceViewerConfiguration(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelResourceProvider resourceProvider, QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelAnnotationModelProvider annotationModelProvider, QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandlerProvider bracketHandlerProvider, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelColorManager colorManager) {
		super(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
