 ...
 */
public class QualitymetamodelCodeFoldingManager {
	
	private class FoldingUpdateListener implements QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) {
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor = (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) workbenchPart;
	...
	protected QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor;
	 ...
	 */
	public QualitymetamodelCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor textEditor) {
	...
	private void addCloseListener(final QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource textResource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
