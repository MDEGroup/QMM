 ...
 */
public class QualitymetamodelUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "QualityMetamodel.resource.qualitymetamodel.ui";
	public static final String EDITOR_ID = "QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor";
	...
	private static QualitymetamodelUIPlugin plugin;
	
	public QualitymetamodelUIPlugin() {
		super();
	}
	...
	public static QualitymetamodelUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, QualitymetamodelUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, QualitymetamodelUIPlugin.PLUGIN_ID, message);
		}
		final QualitymetamodelUIPlugin pluginInstance = QualitymetamodelUIPlugin.getDefault();
