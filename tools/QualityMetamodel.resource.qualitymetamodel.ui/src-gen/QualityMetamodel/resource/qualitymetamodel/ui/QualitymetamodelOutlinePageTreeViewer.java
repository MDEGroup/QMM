 ...
 * a specified depth.
 */
public class QualitymetamodelOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public QualitymetamodelOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.logError("Exception while refreshing outline view", e);
		}
	}
