 ...
 */
public class QualitymetamodelCompletionProposal implements java.lang.Comparable<QualitymetamodelCompletionProposal> {
	 ...
	 */
	private QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelExpectedTerminal expectedTerminal;
	...
	public QualitymetamodelCompletionProposal(QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof QualitymetamodelCompletionProposal) {
			QualitymetamodelCompletionProposal other = (QualitymetamodelCompletionProposal) object;
	...
	public int compareTo(QualitymetamodelCompletionProposal object) {
		if (object instanceof QualitymetamodelCompletionProposal) {
			QualitymetamodelCompletionProposal other = (QualitymetamodelCompletionProposal) object;
