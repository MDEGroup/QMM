 ...
 */
public class QualitymetamodelOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "QualityMetamodel.resource.qualitymetamodel.ui.outlinecontext";
	...
	public QualitymetamodelOutlinePage(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("QualityMetamodel.resource.qualitymetamodel.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOutlinePageActionProvider().getActions(treeViewer);
