 ...
 */
public class QualitymetamodelImageProvider {
	
	public final static QualitymetamodelImageProvider INSTANCE = new QualitymetamodelImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
