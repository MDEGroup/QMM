 ...
 */
public class QualitymetamodelHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public QualitymetamodelHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
