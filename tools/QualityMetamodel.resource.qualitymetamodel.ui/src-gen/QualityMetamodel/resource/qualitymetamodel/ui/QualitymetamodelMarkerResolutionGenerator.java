...
public class QualitymetamodelMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource) {
					QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource customResource = (QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelQuickFix> getQuickFixes(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
