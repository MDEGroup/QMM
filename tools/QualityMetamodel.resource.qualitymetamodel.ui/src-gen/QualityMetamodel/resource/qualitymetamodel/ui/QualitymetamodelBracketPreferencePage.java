 ...
 * </ul>
 */
public class QualitymetamodelBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().getSyntaxName();
	
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public QualitymetamodelBracketPreferencePage() {
		super();
		
		QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelMetaInformation metaInformation = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) {
			((QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) editor).invalidateTextRepresentation();
		}
	}
