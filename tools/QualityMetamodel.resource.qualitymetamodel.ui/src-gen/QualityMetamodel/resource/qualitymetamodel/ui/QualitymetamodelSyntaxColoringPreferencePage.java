 ...
 */
public class QualitymetamodelSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public QualitymetamodelSyntaxColoringPreferencePage() {
		super();
		
		QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation metaInformation = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPixelConverter pixelConverter = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) {
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor emfTextEditor = (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor) editor;
