 ...
 * olInput</code>.
 */
public class QualitymetamodelDocBrowserInformationControlInput {
	
	private final QualitymetamodelDocBrowserInformationControlInput fPrevious;
	private QualitymetamodelDocBrowserInformationControlInput fNext;
	 ...
	 */
	public QualitymetamodelDocBrowserInformationControlInput(QualitymetamodelDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public QualitymetamodelDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public QualitymetamodelDocBrowserInformationControlInput getNext() {
		return fNext;
	}
