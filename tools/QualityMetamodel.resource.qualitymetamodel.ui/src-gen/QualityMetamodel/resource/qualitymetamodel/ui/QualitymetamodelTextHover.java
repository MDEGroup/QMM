 ...
 */
public class QualitymetamodelTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput infoInput = (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHyperlink hyperlink = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl iControl = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput) {
							QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput input = (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl.isAvailable(parent)) {
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl iControl = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public QualitymetamodelTextHover(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.insertPageProlog(buffer, 0, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelTextHover.getStyleSheet());
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.addPageEpilog(buffer);
			return new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return QualityMetamodel.resource.qualitymetamodel.util.QualitymetamodelStreamUtil.getContent(styleSheetURL.openStream());
