...
/**
 * A text editor for 'qualitymetamodel' models.
 * <p>
 * This editor has id
 * <code>QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor</code
 * >
 * The editor's context menu has id
 * <code>QualityMetamodel.resource.qualitymetamodel.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>QualityMetamodel.resource.qualitymetamodel.EditorRuler</code>.
 * </p>
 */
public class QualitymetamodelEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelResourceProvider, QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandlerProvider, QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelAnnotationModelProvider {
	
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelCodeFoldingManager codeFoldingManager;
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBackgroundParsingStrategy bgParsingStrategy = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBackgroundParsingStrategy();
	private java.util.Collection<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener>();
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelColorManager colorManager = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelColorManager();
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOutlinePage outlinePage;
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPropertySheetPage propertySheetPage;
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandler bracketHandler;
	...
	public QualitymetamodelEditor() {
		super();
		setSourceViewerConfiguration(new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), QualitymetamodelEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource currentResource = getResource();
				...
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("QualityMetamodel.resource.qualitymetamodel.EditorContext");
		setRulerContextMenuId("QualityMetamodel.resource.qualitymetamodel.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelNature.activate(inputFile.getProject());
		...
		QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource loadedResource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) {
					setResource((QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the QualitymetamodelEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource textResource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) element.eResource();
			QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextToken token = lexer.getNextToken();
			...
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!QualitymetamodelEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(QualityMetamodel.resource.qualitymetamodel.ui.IQualitymetamodelBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource)) {
					return false;
				}
				QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource textResource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) resource;
				QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
