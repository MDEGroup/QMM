 ...
 * hovers, is a proxy.
 */
public class QualitymetamodelHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public QualitymetamodelHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
