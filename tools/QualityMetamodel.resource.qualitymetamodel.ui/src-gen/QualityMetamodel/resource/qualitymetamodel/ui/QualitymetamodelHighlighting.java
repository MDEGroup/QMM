 ...
 */
public class QualitymetamodelHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionHelper positionHelper = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionHelper();
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelTokenScanner scanner;
	...
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOccurrence occurrence;
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public QualitymetamodelHighlighting(QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelColorManager colorManager, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelTokenScanner(textResource, colorManager);
		occurrence = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
