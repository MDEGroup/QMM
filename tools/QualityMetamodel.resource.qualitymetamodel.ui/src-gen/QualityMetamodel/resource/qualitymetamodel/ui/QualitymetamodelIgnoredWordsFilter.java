 ...
 */
public class QualitymetamodelIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return QualityMetamodel.resource.qualitymetamodel.grammar.QualitymetamodelGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
