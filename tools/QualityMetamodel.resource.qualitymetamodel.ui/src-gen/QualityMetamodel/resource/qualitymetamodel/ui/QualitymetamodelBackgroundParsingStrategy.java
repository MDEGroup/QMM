 ...
 */
public class QualitymetamodelBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource, final QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource, final QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final QualityMetamodel.resource.qualitymetamodel.IQualitymetamodelTextResource resource, final QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource) {
							QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource concreteResource = (QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelResource) resource;
