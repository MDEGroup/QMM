...
public class QualitymetamodelNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public QualitymetamodelNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().getSyntaxName();
	}
