 ...
 */
public class QualitymetamodelNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public QualitymetamodelNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new qualitymetamodel file");
