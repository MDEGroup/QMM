...
public class QualitymetamodelLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelPlugin.DEBUG_MODEL_ID);
			...
			QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelLineBreakpoint lineBreakpoint = new QualityMetamodel.resource.qualitymetamodel.debug.QualitymetamodelLineBreakpoint(resource, lineNumber + 1);
