 ...
 */
public class QualitymetamodelNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public QualitymetamodelNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("QualityMetamodel.resource.qualitymetamodel.ui");
							...
							String natureID = QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelNature.NATURE_ID;
							...
							for (String builderID : QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation info = new QualityMetamodel.resource.qualitymetamodel.mopp.QualitymetamodelMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = QualityMetamodel.resource.qualitymetamodel.ui.QualitymetamodelUIPlugin.getDefault().getBundle();
